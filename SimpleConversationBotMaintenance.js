...
module.exports = {
    ...
    on_user_message : function(requestId, data, callback) {
        ...
        ad.isUserMemberOf(username, groupName, function(err, isMember) {
            ...
            if (isMember === true) {
                data.message = "Hi, I'm Dixi, your Dupixent Assistant. Sorry to inform you that Dixi Chatbot will be down for maintenance. Please be patient until we resume operations. In case of immediate info, Please contact your FRM or call Dupixent My way at (844) 387-4936.";
